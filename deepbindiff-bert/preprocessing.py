...
def preprocessing(filepath1, filepath2, outputDir):
        ...
        # cfg: control flow graph, cg: call graph, edgelist/nodelist: edges and nodes of the control flow graph
        ...
        # blockIdxToTokens[id] = token list of that block
        # examples:  blockIdxToOpcodeNum['1'] = number of opcodes in a block
        # blockIdxToOpcodeCounts['1'] = {'mov': 3, 'call': 2, ...}
        # insToBlockCounts['mov'] = 3
